    ...
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="col-span-2 bg-[#111] border border-white/5 rounded-xl p-3">
        ...
        <p className="text-xs text-white/50 leading-relaxed">
          You earn <span className="text-white font-bold">80%</span> of every sale. Contact <span className="text-primary">@acctplugsupport</span> on Telegram to request your payout.
        </p>
      </div>
    </div>
  );
