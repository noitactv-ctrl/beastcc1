  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6 space-y-5">
      <div className="space-y-1">
        ...
        <p className="text-sm text-white/40">Join ACCTPLUG marketplace and sell your products</p>
      </div>
          ...
          {app.status === "pending" && (
            <div className="bg-[#111] border border-white/5 rounded p-4 space-y-3">
              <p className="text-sm text-white/70">
                Your application is pending. Text your seller code to <strong className="text-white">@acctplugsupport</strong> on Telegram to activate your seller account.
              </p>
              <div className="space-y-1">
              ...
              <p className="text-[11px] text-white/30">
                Message @acctplugsupport on Telegram with your code. Once verified, your seller access will be activated.
              </p>
            </div>
          )}
        </div>
