...
const RANKS = [
  { key: "newbie",  label: "Newbie",  emoji: "🌱", color: "text-white/50",   border: "border-white/10",  glow: "",                        discount: 0,  threshold: 0,      next: 10000  },
  { key: "regular", label: "Regular", emoji: "⭐", color: "text-blue-400",   border: "border-blue-500/30",  glow: "shadow-blue-500/10",     discount: 2,  threshold: 10000,  next: 50000  },
  { key: "vip",     label: "VIP",     emoji: "💎", color: "text-purple-400", border: "border-purple-500/30", glow: "shadow-purple-500/10",  discount: 5,  threshold: 50000,  next: 100000 },
  { key: "nyc",     label: "NYC",     emoji: "🗽", color: "text-amber-400",  border: "border-amber-500/30",  glow: "shadow-amber-500/10",   discount: 10, threshold: 100000, next: null   },
];
              ...
              {next ? (
                <div className="space-y-2">
                  ...
                  <div className="h-1.5 rounded-full bg-white/5 overflow-hidden">
                    <div
                      className={`h-full rounded-full ${current.color.replace("text-", "bg-")} transition-all`}
