          ...
          <TabsContent value="stock" className="space-y-4 mt-4">
            <div className="p-4 bg-[#1c1f26] rounded-lg space-y-4 border border-white/5">
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm font-medium">Add Stock <span className="text-muted-foreground text-xs">(end each item with ļ)</span></div>

                <div className="space-y-2">
                  <Textarea 
                    placeholder={'user@email.com:password123ļuser2@email.com:pass456ļanother account info here'}
                  ...
                  <div className="flex items-center justify-between text-[10px] text-muted-foreground">
                    <span>Items to add: {newStockContent.split('ļ').map(s => s.trim()).filter(s => s.length > 0).length}</span>
