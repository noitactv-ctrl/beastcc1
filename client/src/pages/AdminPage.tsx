...
export default function AdminPage() {
  ...
  return (
    <div className="space-y-8 bg-[#090a0c] min-h-screen text-white pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-[#16181d] border-white/5 shadow-2xl">
          ...
          <CardContent>
            <div className="text-2xl font-black italic tracking-tighter">{stats?.totalUsers || 0}</div>
          </CardContent>
        </Card>
        <Card className="bg-[#16181d] border-white/5 shadow-2xl">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Card className="bg-[#16181d] border-white/5 shadow-2xl">
          ...
          <CardContent>
            <div className="text-2xl font-black italic text-accent tracking-tighter">{products?.length || 0}</div>
          </CardContent>
        </Card>
        <Card className="bg-[#16181d] border-white/5 shadow-2xl">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-black italic text-destructive tracking-tighter">{stats?.totalOrders || 0}</div>
          </CardContent>
        </Card>
      </div>
                      ...
                      <div key={p.id} className="p-4 rounded-xl bg-[#1c1f26] border border-white/5 flex items-center justify-between group hover:border-primary/30 transition-colors">
                         <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[9px] font-bold text-muted-foreground uppercase">{p.variants?.length || 0} Options</span>
                            </div>
                         </div>
