...
export const users = pgTable("users", {
  ...
  telegramNameSignature: text("telegram_name_signature").default("").notNull(),
  telegramChannelMember: boolean("telegram_channel_member").default(false).notNull(),
  telegramNameEligible: boolean("telegram_name_eligible").default(false).notNull(),
...
export const insertUserSchema = createInsertSchema(users).omit({ 
  ...
  loginCode: true,
  telegramChatId: true,
  telegramNameSignature: true,
  telegramChannelMember: true,
  telegramNameEligible: true,
